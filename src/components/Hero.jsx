...
//To show polygon clip path animation on scroll
  useGSAP(() => {
        ...
        <div>
          ...
          <div className="absolute left-0 top-0 z-40 size-full">
            <div className="mt-24 px-5 sm:px-10">
              ...
              <Button title={"Watch Trailer"} id={"watch-trailer"} leftIcon={<TiLocationArrow/>} ContainerClass= "!bg-yellow-300 flex-center gap-1"/>
            </div>
          </div>
      </div>
